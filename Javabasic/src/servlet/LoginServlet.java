...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd= request.getServletContext().getRequestDispatcher("/WEB-INF/views/Home/Login.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userAccountBO.checkLogin(userName, password)){
...
//			request.getRequestDispatcher("/WEB-INF/views/Home/Index.jsp").forward(request, response);
			...
			request.setAttribute("Notification", "User Name or Password was wrong!");
