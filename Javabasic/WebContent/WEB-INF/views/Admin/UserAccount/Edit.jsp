...
<mt:admin_template title="">
	<jsp:attribute name="content">
		...
		<div style="text-align: center;"><h2>Edit Account</h2></div>
		<hr>
		<form class="needs-validation" action="Edit" method="post" novalidate>		
					<div class="form-inline">
							<div class="col-md-6 sty" hidden="hidden">
		                            <div class="form-group">
		                            	<label class="control-label col-md-5">User Id</label>
		                                    <div class="col-md-1">
			                                    <input class="form-control" value="${userId }"
															type="text" name="userId" required="required" readonly="readonly">
											</div>
		                            </div>
		                    </div>
		                            	...
		                            	<label class="control-label col-md-5">User Name</label>
		                                    <div class="col-md-1">
			                                    <input class="form-control" value="${userName }"
															type="text" name="userName" required="required" readonly="readonly">
											</div>
		                            </div>
		                    </div>
		                    ...
		                    <div class="col-md-6 sty">
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-1">
		                                    <input class="form-control" value="${profilePicture}"
		                    ...
		                    <div class="col-md-12 sty">
	                            ...
	                            <div class="col-md-offset-2 col-md-10">
									...
									<a href="/SampleWeb/Management/UserAccount"  class="btn btn-primary">Cancel</a>	           
	                            </div>
